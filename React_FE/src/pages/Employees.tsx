...
const Employees = () => {
    ...
    const getAllEmployees = async () => {
        try {
            const response = await axios.get("http://localhost:8080/mongobe/api/v1/employee/getAll");
    ...
    const getNextCode = async () => {
        try {
            const response = await axios.get("http://localhost:8080/mongobe/api/v1/employee/getNextCode");
            if (response.status === 200) {
    ...
    const saveEmployee = async () => {
        ...
        try {
            const response = await axios.post("http://localhost:8080/mongobe/api/v1/employee/save", employeeJSON, {
                headers: {
    ...
    const updateEmployee = async () => {
        ...
        try {
            const response = await axios.put("http://localhost:8080/mongobe/api/v1/employee/update", employeeJSON, {
                headers: {
                    'Content-Type': 'application/json'
                }
            });
    ...
    const deleteEmployee = async () => {
        ...
        try {
            const response = await axios.delete(`http://localhost:8080/mongobe/api/v1/employee/delete/${employeeCode}`);
            if (response.status === 200) {
